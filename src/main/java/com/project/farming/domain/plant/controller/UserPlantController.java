...
//            )
    ...
    @Operation(summary = "사용자 식물 목록 검색",
            description = "사용자 ID에 해당하는 사용자가 등록한 식물 중에서 입력한 키워드(식물 종류 또는 별명)를 포함하는 모든 식물을 별명 순으로 조회합니다.")
    ...
    @Operation(summary = "특정 사용자 식물 정보 조회",
            description = "사용자 ID에 해당하는 사용자의 특정 식물의 상세 정보를 조회합니다. 식물(Plant)의 상세 정보도 반환합니다.")
