...
public class UserPlantController {
    ...
    public ResponseEntity<UserPlantResponseDto> getUserPlant(@PathVariable Long userId, @PathVariable Long userPlantId) {
    ...
    public ResponseEntity<UserPlantResponseDto> updateUserPlant(
            @PathVariable Long userId, @PathVariable Long userPlantId, @Valid @RequestBody UserPlantRequestDto request) {
    ...
    public ResponseEntity<UserPlantResponseDto> deleteUserPlant(@PathVariable Long userId, @PathVariable Long userPlantId) {
